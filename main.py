...
def main():
    ...
    ret += '<form action="/dev/" method="post"><button name="Comp Move" type="submit">Make Comp Move</button></form>'
...
def dev():
    try:
        ...
        traceback.print_exc()
        flash("illegal move, try again", "error")
    return main()

# New Game
@app.route("/game/", methods=['POST'])
def game():
    flash("Board Reset, Best of Luck for the next game.","pop up")
    board.reset()
    return main()
